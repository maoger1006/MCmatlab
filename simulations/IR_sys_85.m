...
model.G.Lz                = 1.3; % [cm] z size of simulation cuboid (1.305)
...
model.MC.nPhotonsRequested  = 1e08; % [min] Time duration of the simulation
...
for i = 1:length(mel_vec)
  ...
  for iRun = 1:n
     model = runMonteCarlo(model);
     R2(i,iRun) = model.G.dx*model.G.dy*sum(model.MC.NI_zpos(:));
...
function M = geometryDefinition(X,Y,Z,parameters)
  ...
  M(Z > corneum_thick + epidermis_thick + papillary_thick + upper_dermis + reticular_dermis + deep_dermis ) = 7;%fat
  M(Z > corneum_thick + epidermis_thick + papillary_thick + upper_dermis + reticular_dermis + deep_dermis + fat_thick)= 8;%muscle
  M(Z > corneum_thick + epidermis_thick + papillary_thick + upper_dermis + reticular_dermis + deep_dermis + fat_thick + muscle_thick)= 7;%fat                                                                                               
  M(Z > corneum_thick + epidermis_thick + papillary_thick + upper_dermis + reticular_dermis + deep_dermis + 2*fat_thick + muscle_thick)= 6;%deep_dermis
  M(Z > corneum_thick + epidermis_thick + papillary_thick + upper_dermis + reticular_dermis + 2*deep_dermis + 2*fat_thick + muscle_thick)= 5;% reticular_dermis
  M(Z > corneum_thick + epidermis_thick + papillary_thick + upper_dermis + 2*reticular_dermis + 2*deep_dermis + 2*fat_thick + muscle_thick)= 4;%upper_dermis
  M(Z > corneum_thick + epidermis_thick + papillary_thick + 2*upper_dermis + 2*reticular_dermis + 2*deep_dermis + 2*fat_thick + muscle_thick)= 3;% papillary
  M(Z > corneum_thick + epidermis_thick + 2*papillary_thick + 2*upper_dermis + 2*reticular_dermis + 2*deep_dermis + 2*fat_thick + muscle_thick)= 2; % epidermis
  M(Z > corneum_thick + 2*epidermis_thick + 2*papillary_thick + 2*upper_dermis + 2*reticular_dermis + 2*deep_dermis + 2*fat_thick + muscle_thick)= 1;% stratum corneum
