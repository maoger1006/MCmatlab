...
model.MC.nPhotonsRequested  = 1e04; % [min] Time duration of the simulation
...
% NFRslice = squeeze(model.MC.NFR(:,:,350));
% figure(7);
% imagesc(model.G.x,model.G.y, NFRslice.');
