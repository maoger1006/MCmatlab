...
model.G.Lz                = 1.305+0.0475*0.5; % [cm] z size of simulation cuboid
...
writematrix(R1,'Results.xlsx','Sheet',2,'Range' , 'A6')

%% Geometry function(s) (see readme for details)
function M = geometryDefinition(X,Y,Z,parameters)
  % Blood vessel example:
  corneum_thick = 0.002*1.125;
  epidermis_thick = 0.025*1.125;
  papillary_thick = 0.01*1.125;
  upper_dermis = 0.008*1.125;
  reticular_dermis = 0.02*1.125;
  deep_dermis = 0.03*1.125;
  muscle_thick = 1;
  fat_thick = 0.055;
  boneradius  = 0.2;
  bonedepth = 0.5;
