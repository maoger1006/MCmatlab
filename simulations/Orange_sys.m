...
model.MC.wavelength               = 600; % [nm] Excitation wavelength, used for determination of optical properties for excitation light
...
%   mua_base = 7.84*(10^7)*(model.MC.wavelength )^(-3.255);
  ...
  mediaProperties(j).mua = (Vart*mua_art + Vven*mua_ven + Vw*mua_w + (1-(Vart + Vven + Vw))* mua_base);
  
  
  
  mediaProperties(j).mus = 880;
  mediaProperties(j).g   = 0.95;   % Scattering anisotropy
...
%   end
  ...
  mediaProperties(j).mua = (Vmel*mua_mel +  Vw*mua_w + (1-(Vmel + Vw))* mua_base);
...
%   end
  ...
  mediaProperties(j).mua = 0.3;
  mediaProperties(j).mus = 80 ;
...
%   end
  ...
  mediaProperties(j).mus = 100;  % Jacques "Optical properties of biological tissues: a review" eq. 2
...
%   end
  ...
  mediaProperties(j).mua = 1;
  mediaProperties(j).mus = 400;  % Jacques "Optical properties of biological tissues: a review" eq. 2
