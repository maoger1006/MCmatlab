...
model.G.Lz                = 1.305; % [cm] z size of simulation cuboid
...
model.MC.nPhotonsRequested  = 2e+05; % [min] Time duration of the simulation
...
writematrix(R2,'Results.xlsx','Sheet',1,'Range' , 'A10')
