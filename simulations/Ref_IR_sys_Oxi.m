...
model.MC.nPhotonsRequested  = 1e+06; % [min] Time duration of the simulation
...
model.MC.lightCollector.y         = 0.2; % [cm] y position
...
% for i = 1:3
%          model.MC.lightCollector.y         = i/5-0.2; % [cm] y position
%   for iRun = 1:n
%      
%      model = runMonteCarlo(model);
%      R2(i,iRun) = model.MC.lightCollector.image*100;
