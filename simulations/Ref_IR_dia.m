...
model.G.Lz                = 1.302; % [cm] z size of simulation cuboid
...
model.MC.nPhotonsRequested  = 1e+04; % [min] Time duration of the simulation
...
%   for iRun = 1:n
%      model = runMonteCarlo(model);
%      R1(i,iRun) = model.MC.lightCollector.image*100;
%      
